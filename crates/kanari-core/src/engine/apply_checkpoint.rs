...
type PreparedCheckpointState = (Vec<u8>, StateManager, Vec<TransactionExecutionReceipt>);
...
impl BlockchainEngine {
    ...
    fn finalize_checkpoint(
        ...
        self.stage_checkpoint_commit(&mut new_state, &checkpoint, &receipts, &candidate_chain)?;
        new_state
            .commit()
