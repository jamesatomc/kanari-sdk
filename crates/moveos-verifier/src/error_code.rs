...
pub enum ErrorCode {
    ...
    INVALID_DATA_STRUCT_OVER_MAX_TYPE_DEPTH = 10019,
    INVALID_DATA_STRUCT_WITH_NATIVE_STRUCT = 10020,
    ...
    INVALID_DATA_STRUCT_INCOMPATIBLE_REMOVE = 13001,
    INVALID_DATA_STRUCT_INCOMPATIBLE_MODIFY = 13002,
    INVALID_DATA_STRUCT_FUNC_INCOMPATIBLE_REMOVE = 13003,
    INVALID_DATA_STRUCT_FUNC_INCOMPATIBLE_MODIFY = 13004,
    INVALID_PRIVATE_GENERICS_INCOMPATIBLE_REMOVE = 13005,
    INVALID_PRIVATE_GENERICS_INCOMPATIBLE_MODIFY = 13006,
    INVALID_DATA_STRUCT_INCOMPATIBLE_WITH_EXISTS = 13007,
    INVALID_DATA_STRUCT_FUNC_INCOMPATIBLE_WITH_EXISTS = 13008,
    INVALID_PRIVATE_GENERICS_INCOMPATIBLE_WITH_EXISTS = 13009,
