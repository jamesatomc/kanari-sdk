...
pub use vm_integration::{
    ContractEvent, VM_PROCESSOR, VMTransactionProcessor, VMTransactionResult, VMTransactionType,
    call_contract_global, deploy_contract_global, query_contract_global,
};
